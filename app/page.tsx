      ...
      <section id="top" className="hero section-dark">
        <div className="container hero-grid">
          <div className="hero-copy">
            ...
            <div className="hero-actions"><a className="button button-light" href="/contact">Begin your journey <Arrow /></a><a className="text-link light-link" href="/how-it-works">See how it works <span aria-hidden="true">↓</span></a></div>
          </div>
          <div className="hero-art mascot-hero" aria-label="WellNaija mascot welcoming you" role="img">
            <div className="art-sun" /><img src="/images/mascot-welcome.png" alt="WellNaija mascot waving hello" /><span className="art-caption">A healthier<br />you, together.</span>
          </div>
        </div>
